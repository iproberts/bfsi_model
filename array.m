classdef array < matlab.mixin.Copyable
    ...
    methods
        ...
        function show_polar_near_field_array_pattern_azimuth(obj,dist,ax,el,N,full)
        ...
        function show_beam_codebook_3d(obj,F)
            AoA_ele_rad = linspace(-pi/2,pi/2);
            AoA_azi_rad = linspace(-pi/2,pi/2);
        ...
        function v = get_near_field_response(obj,freq,x,y,z)
            ...
            % for i = 1:length(x)
            %     w = v(:,i);
            %     v(:,i) = w ./ norm(w,2) * sqrt(obj.num_antennas);
            % end
        end
